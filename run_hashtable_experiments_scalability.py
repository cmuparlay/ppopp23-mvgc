...
if len(sys.argv) == 1 or sys.argv[1] == '-h':
  print("Usage: python3 run_hashtable_experiments_scalability.py [num_keys] [ins-del-find-rq-rqsize] [thread_list] [outputfile] [num_repeats] [runtime] [JVM memory size] [zipf]")
  print("For example: python3 run_hashtable_experiments_scalability.py 10000 3-2-95-0-0 [1,4] graph.png 1 1 1G 0")
  exit(0)
...
graphtitle = "Hashtable scalability: " + num_keys + "keys-" + ins + "ins-" + rmv + "del-" + rq + "rq-" + rqsize + "rqsize-" + inc_update
if zipf == 0:
  graphtitle += "-uniform"
else:
