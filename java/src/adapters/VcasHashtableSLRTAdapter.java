...
import algorithms.hashtable.VcasHashtableSLRT;
...
public class VcasHashtableSLRTAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K>, ProfileableHashtable {
    public VcasHashtableSLRT<K,K> ds;

    public VcasHashtableSLRTAdapter() {
        ds = new VcasHashtableSLRT();
    }

    public VcasHashtableSLRTAdapter(final int tableSize) {
        ds = new VcasHashtableSLRT(tableSize);
    }

    public void cleanup() { ds.cleanup(); }
