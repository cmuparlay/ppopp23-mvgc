...
import algorithms.tree.VcasChromaticMapEpoch;

public class VcasChromaticEpochAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K>, ProfileableV2 {
    public VcasChromaticMapEpoch<K,K> tree;
    ...
    public VcasChromaticEpochAdapter() {
        tree = new VcasChromaticMapEpoch();
    }

    public VcasChromaticEpochAdapter(final int allowedViolations) {
        tree = new VcasChromaticMapEpoch(allowedViolations);
    }
