...
import algorithms.tree.VcasChromaticMapDLRT;
import main.support.*;

import java.util.ArrayList;

public class VcasChromaticDLRTAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K>, Profileable {
    public VcasChromaticMapDLRT<K,K> tree;
    ...
    public VcasChromaticDLRTAdapter() {
        tree = new VcasChromaticMapDLRT();
    }

    public VcasChromaticDLRTAdapter(final int allowedViolations) {
        tree = new VcasChromaticMapDLRT(allowedViolations);
    }
    ...
    public void cleanup() { VcasChromaticMapDLRT.cleanup(); }
