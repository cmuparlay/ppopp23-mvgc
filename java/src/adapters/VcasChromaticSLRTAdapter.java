...
import algorithms.tree.VcasChromaticMapSLRT;
import main.support.*;

import java.util.ArrayList;

public class VcasChromaticSLRTAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K>, ProfileableV2 {
    public VcasChromaticMapSLRT<K,K> tree;
    ...
    public VcasChromaticSLRTAdapter() {
        tree = new VcasChromaticMapSLRT();
    }
    public VcasChromaticSLRTAdapter(final int allowedViolations) {
        tree = new VcasChromaticMapSLRT(allowedViolations);
    }

    public void cleanup() { VcasChromaticMapSLRT.cleanup(); }
