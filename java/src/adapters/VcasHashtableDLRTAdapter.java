...
import algorithms.hashtable.VcasHashtableDLRT;
...
public class VcasHashtableDLRTAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K>, ProfileableHashtable {
    public VcasHashtableDLRT<K,K> ds;

    public VcasHashtableDLRTAdapter() {
        ds = new VcasHashtableDLRT();
    }

    public VcasHashtableDLRTAdapter(final int tableSize) {
        ds = new VcasHashtableDLRT(tableSize);
    }

    public void cleanup() { VcasHashtableDLRT.cleanup(); }
