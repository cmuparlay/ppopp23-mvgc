...
import algorithms.hashtable.VcasHashtableSteamLF;
...
public class VcasHashtableSteamLFAdapter<K extends Comparable<? super K>> extends AbstractAdapter<K> implements SetInterface<K>, ProfileableHashtable {
    public VcasHashtableSteamLF<K,K> ds;

    public VcasHashtableSteamLFAdapter() {
        ds = new VcasHashtableSteamLF();
    }

    public VcasHashtableSteamLFAdapter(final int tableSize) {
        ds = new VcasHashtableSteamLF(tableSize);
    }
