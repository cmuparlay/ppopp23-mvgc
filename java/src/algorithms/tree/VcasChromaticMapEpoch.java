...
public class VcasChromaticMapEpoch<K extends Comparable<? super K>,V> {
    ...
    public VcasChromaticMapEpoch() {
        this(DEFAULT_d);
    }

    public VcasChromaticMapEpoch(final int allowedViolationsPerPath) {
