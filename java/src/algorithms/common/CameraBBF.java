...
public class CameraBBF {
  public static final int PADDING = 32;
  public static RangeTracker rt = new RangeTracker();
  public static long[] dummyCounters = new long[ThreadID.MAX_THREADS*PADDING];
 @Contended
  public volatile long timestamp;

  private static final AtomicLongFieldUpdater<CameraBBF> timestampUpdater = AtomicLongFieldUpdater.newUpdater(CameraBBF.class, "timestamp");
  ...
  public static CameraBBF camera = new CameraBBF();
