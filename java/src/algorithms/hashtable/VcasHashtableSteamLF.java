...
public class VcasHashtableSteamLF<K extends Comparable<? super K>,V> {

    private static final int DEFAULT_SIZE = 1000000;

    private int num_buckets;
    private AtomicReferenceArray<HeadNode<K,V>> buckets;
...
//            System.out.println(newHead.ts);
    ...
    public VcasHashtableSteamLF() {
        this(DEFAULT_SIZE);
    }

    public VcasHashtableSteamLF(int size) {
